...
public class PlayerController extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private int iconPause = R.drawable.video_play_pause_ic;
    private int iconPlay = R.drawable.video_play_start_ic;

    int iconShrink = R.drawable.video_play_shrink_ic;
    int iconExpand = R.drawable.video_play_expand_ic;
