...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    private boolean longPressDragEnabled = false, swipeEnabled = false;
    ...
    public SimpleItemTouchHelperCallback(ItemTouchHelperAdapter adapter, boolean longPressDragEnabled) {
        this(adapter, longPressDragEnabled, false);
    }

    public SimpleItemTouchHelperCallback(ItemTouchHelperAdapter adapter, boolean longPressDragEnabled, boolean swipeEnabled) {
        mAdapter = adapter;
