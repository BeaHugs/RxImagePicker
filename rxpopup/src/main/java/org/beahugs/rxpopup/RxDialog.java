...
public class RxDialog extends RxBaseDialog implements IDialog {

    private Context context;
    private RxDialogController controller;
    ...
    public RxDialog() {
        controller = new RxDialogController(this);
    }
    ...
    public static class Builder {
        private RxDialogController.SYParams params;
        private IDialog.OnBuildListener buildListener;
        private IDialog.OnDismissListener dismissListener;
        ...
        public Builder(Context context) {
            ...
            params = new RxDialogController.SYParams();
        ...
        /**
         * 设置样式 风格  ios android_md 自定义
         * @param style
         * @return
         */
        public Builder setStyle(DiaLogSettings.STYLE style) {
            params.style = style;
            return this;
        }

        private RxDialog create() {
            RxDialog dialog = new RxDialog();
        ...
        public RxDialog show() {
            ...
            switch (params.style){
                case STYLE_IOS:
                    params.layoutRes = R.layout.dialog_select_ios;
                    break;
                case STYLE_MATERIAL:
                    params.layoutRes = R.layout.dialog_select_ios;
                    break;
                case STYLE_USE:
                    params.layoutRes = R.layout.dialog_select;
                    break;
            }
