...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.ViewHolder> {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mImageFolderChangeListener != null) {
                    mImageFolderChangeListener.OnFolderSelect(folder);
                }
            }
        });
    }
     ...
     * 接口回调，Item点击事件
     */
    private OnFolderSelectListener mImageFolderChangeListener;

    public void setOnImageFolderChangeListener(OnFolderSelectListener onItemClickListener) {
